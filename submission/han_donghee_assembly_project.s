...
# 
# To improve the LED interface, I've defined two custom functions and a
#   number of helper functions that the afformentioned custom functions
#   use to interact with several LEDs at once.
#
# Custom functions:
# =================
...
main:
    ...
    jal rand
    #
    sb a0, 0(s11)    # s11 = arr[i]  <--  (RANDOM NUMBER)
    addi a3, a3, 1   # a3++ = i++
    # -------------------------------------------------------------
